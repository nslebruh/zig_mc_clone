...
pub fn build(b: *std.Build) void {
    ...
    const zgl_dep = b.dependency("zgl", .{.optimize = optimize, .target = target});
    ...
    const zigmath_dep = b.dependency("zigmath", .{.optimize = optimize, .target = target});

    exe.root_module.addImport("zglm", zigmath_dep.module("zglm"));
